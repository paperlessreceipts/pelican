...
class TestJinja2Environment(unittest.TestCase):
    ...
    def test_jinja2_filter(self):
        """JINJA_FILTERS adds custom filter to jinja2 environment"""
    ...
    def test_jinja2_test(self):
        """JINJA_TESTS adds custom test to jinja2 environment"""
    ...
    def test_jinja2_global(self):
        """JINJA_GLOBALS adds custom global to jinja2 environment"""
    ...
    def test_jinja2_extension(self):
        """JINJA_EXTENSIONS adds extension to jinja2 environment"""
        content = '{% set stuff = [] %}{% do stuff.append(1) %}{{ stuff }}'
        settings = {'JINJA_EXTENSIONS': ['jinja2.ext.do']}
        expected = '[1]'
